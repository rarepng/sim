...
export interface PhysicsWorld {
     ...
     */
    createCloth(sx: number, sy: number, sz: number, w: number, h: number, sep: number, k: number, damp: number): void;
 ...
 */
export default function createSimModule(moduleOverrides?: any): Promise<SimModule>;